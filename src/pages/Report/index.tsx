...
const Flink = () => {
  ...
  return (
    <CSVLink separator={";"} data={csvData}>
      <Button icon={<FileExcelOutlined />} key="1"></Button>
    </CSVLink>
  );
};
                  ...
                  <Row gutter={24}>
                    ...
                    <Col>
                      ...
                      >
                        ...
                        >
                          <Select.Option value="Думкина Елена Анатольевна">
                            Думкина Елена Анатольевна
                          </Select.Option>
                          <Select.Option value="Коваленков Михаил Вениаминович">
                            Коваленков Михаил Вениаминович
                          </Select.Option>
                          <Select.Option value="Злобина Оксана Александровна">
